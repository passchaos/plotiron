    ...
    fn add_arrow(&self, axes: &mut Axes, from: &Node, to: &Node) {
        ...
        if length > 0.0 {
            ...
            let node_radius_svg = {
                ...
                let radius_x = crate::utils::map_range(node_radius_logical, 0.0, x_max - x_min, 0.0, plot_width);
                let radius_y = crate::utils::map_range(node_radius_logical, 0.0, y_max - y_min, 0.0, plot_height);
